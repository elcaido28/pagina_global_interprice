...
$cons="SELECT * FROM todas_facturas where id_todas_facturas='$id_paquete' ";
...
$pdf->MultiCell(150,5,utf8_decode("NOMBRES: ".$row['destinatario']),0,'L',0);
$pdf->MultiCell(150,5,utf8_decode("DIRECCIÓN: ".$row['direccion_destinatario']),0,'L',0);
$pdf->Cell(95,6,utf8_decode("CEDULA: ".$row['cedula_destinatario']),0,1,'L');
...
$pdf->MultiCell(190,5,utf8_decode($row['descripcion']),'LRB','L',0);
